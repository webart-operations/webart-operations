          ...
          <Card flush>
            <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ position: 'relative', width: 300 }}>
                 ...
                 <input className="input" placeholder="Search invoices or clients..." style={{ paddingLeft: 36 }} value={search} onChange={e=>setSearch(e.target.value)} />
              </div>
            </div>
                    ...
                    <tr key={p.id}>
                      ...
                      <td>
                        ...
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-3)', display: 'flex', alignItems: 'center', gap: 6 }}>
                          {p.projects?.product}
                          {p.is_reactivation && <Pill status="warning" label="Reactivation" noDot style={{ fontSize: '0.625rem', padding: '1px 6px' }} />}
                        </div>
                      </td>
                      <td><code style={{ fontSize: '0.75rem' }}>{p.invoice_number}</code></td>
                      <td>
                      ...
                      <td>
                        <div style={{ fontWeight: 600 }}>{p.logged_by || 'N/A'}</div>
                      </td>
